...
from causica.distributions import NoiseAccessibleBernoulli
...
def test_init():
    ...
    noise_model = NoiseAccessibleBernoulli(x_hat, base_logits)
...
def test_sample_to_noise(x_hat, base_logits):
    ...
    noise_model = NoiseAccessibleBernoulli(delta_logits=x_hat, base_logits=base_logits)
