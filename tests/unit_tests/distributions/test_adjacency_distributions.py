...
from causica.distributions.adjacency_distributions import AdjacencyDistribution
from causica.distributions.enco import ENCOAdjacencyDistribution
from causica.distributions.simple import SimpleAdjacencyDistribution
from causica.distributions.three_way import ThreeWayAdjacencyDistribution
...
def _distribution_factory(
    ...
    elif dist_class == SimpleAdjacencyDistribution:
        return SimpleAdjacencyDistribution(logits=torch.randn(batch_shape + (num_nodes, num_nodes)))
    raise ValueError("Unrecognised Class")


DIST_CLASSES = [ThreeWayAdjacencyDistribution, ENCOAdjacencyDistribution, SimpleAdjacencyDistribution]
