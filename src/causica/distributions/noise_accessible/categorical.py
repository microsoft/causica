...
class NoiseAccessibleCategorical(OneHotCategorical, NoiseAccessible):
    def __init__(self, delta_logits: torch.Tensor, base_logits: torch.Tensor):
        """
        A Categorical distribution with parameters defined by base_logits and self.delta_logits (predictions from ICGNN).
